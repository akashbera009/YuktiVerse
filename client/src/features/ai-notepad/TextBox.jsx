...
const TextBox = React.memo(({ box, isActive, onChange, onBlur, onDelete, onAIButton, aiButtonRef, onDragStop, onResizeStop, onMouseDown, popover }) => {
  ...
  return (
    <Rnd
      ...
      onResizeStop={(e, direction, ref, delta, position) => onResizeStop(box.id, ref, position)}
