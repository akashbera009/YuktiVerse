...
const uploadFiles = async () => {
  ...
  for (const fileData of files) {
    try {
      await onFilesUploaded([{ file: fileData.file, name: fileData.name }]);
    } catch (err) {
      console.error(`❌ Upload failed for: ${fileData.name}`, err);
      failedUploads.push(fileData.name);
    }
  }
  ...
  <div className="up-uploader-container">
    <div className="up-uploader-content">
      <div className="up-uploader-header">
        {/* <h2 className="up-uploader-title">
          Upload Your Files
        </h2> */}
        <p className="up-uploader-subtitle">
         Upload Your Files
        </p>
      </div>
      ...
      >
        ...
        {/* <p className="up-upload-zone-subtitle">
              ...
              <div key={file.id} className="up-file-item-2">
                {file.preview ? (
                  <img
                    src={file.preview}
                    alt={file.name}
                    className="up-file-preview"
                  />
                ) : (
                  <div className="up-file-icon-container">
