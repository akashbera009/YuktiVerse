...
const NotificationCard = () => {
  return (
    <div className="notification-card">
      <svg className="notification-card-wave" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <div className="notification-card-text-container">
        <p className="notification-card-message-text">Success message</p>
        <p className="notification-card-sub-text">Everything seems great</p>
      </div>
