...
router.post('/notebook/:notebookId/generate', protect ,generateShareLink);
...
router.delete('/notebook/:shareId', protect, revokeShareLink);

// Get all shared notebooks by user (protected route)
router.get('/user/notebooks', protect, getUserSharedNotebooks);
